...
COLLECTIBLES: list[dict[str, Any]] = [
    ...
    {"id": "dragon_tooth", "name": "Dragon Tooth", "image": "collectibles/equip_icon_dragon_tooth.png", "cost_gold": 200, "unlock_with_gems": True, "unlock_at_level": 26, "effect": {"luck_gem_chance_percent": 8}, "effect_description": "+8% gem luck", "rarity": "rare"},
