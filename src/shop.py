...
COLLECTIBLES: list[dict[str, Any]] = [
    ...
    {"id": "meat_feast", "name": "Meat Feast", "image": "collectibles/icon_food_meat.png", "cost_gold": 380, "unlock_with_gems": False, "unlock_at_level": 65, "effect": {"xp_flat": 2, "gold_flat": 3}, "effect_description": "+2 XP/review, +3g earned", "rarity": "rare"},
    ...
    {"id": "compass", "name": "Compass", "image": "collectibles/compass.png", "cost_gold": 130, "unlock_with_gems": False, "unlock_at_level": 20, "effect": {"dungeon_discover_percent": 20}, "effect_description": "+20% chance to find a dungeon", "rarity": "rare"},
    ...
    {"id": "poison", "name": "Poison", "image": "collectibles/poison.png", "cost_gold": None, "unlock_with_gems": False, "unlock_at_level": 15, "weight": 5, "effect": {"dungeon_explore_percent": 11}, "effect_description": "+11% faster dungeon exploration", "rarity": "rare"},
    {"id": "skull_scroll", "name": "Skull Scroll", "image": "collectibles/skull_scroll.png", "cost_gold": None, "unlock_with_gems": False, "unlock_at_level": 15, "weight": 4, "effect": {"dungeon_explore_percent": 15}, "effect_description": "+15% faster dungeon exploration", "rarity": "epic"},
