...
COLLECTIBLES: list[dict[str, Any]] = [
    ...
    {"id": "fish", "name": "Fish", "image": "collectibles/equip_icon_fish.png", "cost_gold": 42, "unlock_with_gems": True, "unlock_at_level": 1, "effect": {"luck_gem_chance_percent": 3}, "effect_description": "Luck 3%", "rarity": "common"},
    ...
    {"id": "package", "name": "Package", "image": "collectibles/Package.png", "cost_gold": 28, "unlock_with_gems": True, "unlock_at_level": 1, "effect": {"luck_gem_chance_percent": 2}, "effect_description": "Luck 2%", "rarity": "common"},
    # --- Level 5 (gap 2–4) ---
    ...
    {"id": "poison_tooth", "name": "Poison Tooth", "image": "collectibles/equip_icon_posion_tooth.png", "cost_gold": 50, "unlock_with_gems": True, "unlock_at_level": 5, "effect": {"luck_gem_chance_percent": 3}, "effect_description": "Luck 3%", "rarity": "common"},
    ...
    {"id": "leaf", "name": "Leaf", "image": "collectibles/equip_icon_leaf.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 8, "effect": {"luck_gem_chance_percent": 4}, "effect_description": "Luck 4%", "rarity": "rare"},
    {"id": "shield_wood", "name": "Wood Shield", "image": "collectibles/equip_icon_shield_wood.png", "cost_gold": 70, "unlock_with_gems": True, "unlock_at_level": 8, "effect": {"luck_gem_chance_percent": 1, "gold_flat": 1}, "effect_description": "Luck 1%, +1g earned", "rarity": "common"},
    # --- Level 10 ---
    ...
    # --- Level 12 ---
    {"id": "key_bronze", "name": "Bronze Key", "image": "collectibles/icon_key_bronze.png", "cost_gold": 120, "unlock_with_gems": True, "unlock_at_level": 12, "effect": {}, "effect_description": "Unlocks shop refresh (2h). 1 free/day, then 15g+", "rarity": "common"},
    ...
    # ============ MID — 18, 22, 26, 30, 35 ============
    {"id": "ring_blue", "name": "Blue Ring", "image": "collectibles/equip_icon_ring_blue.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 18, "effect": {"xp_bonus_percent": 4, "xp_flat": 1}, "effect_description": "+4% XP, +1 XP", "rarity": "rare"},
    {"id": "cloverleaf", "name": "Lucky Clover", "image": "collectibles/Cloverleaf.png", "cost_gold": 333, "unlock_with_gems": True, "unlock_at_level": 18, "effect": {"luck_gem_chance_percent": 6}, "effect_description": "Luck 6%", "rarity": "rare"},
    ...
    {"id": "skull", "name": "Skull", "image": "collectibles/Skull (Border).png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 40, "effect": {"gold_bonus_percent": 10, "luck_gem_chance_percent": 6}, "effect_description": "+10% Gold, Luck 6%", "rarity": "rare"},
    {"id": "sword", "name": "Sword", "image": "collectibles/Sword (Border).png", "cost_gold": 350, "unlock_with_gems": True, "unlock_at_level": 45, "effect": {"quest_reward_bonus_percent": 10}, "effect_description": "+10% daily quest rewards", "rarity": "epic"},
    ...
    {"id": "key_gold", "name": "Golden Key", "image": "collectibles/icon_key_gold.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 45, "effect": {}, "effect_description": "2 free refreshes per day", "rarity": "epic"},
    ...
    {"id": "eye_blue", "name": "Void's Eye", "image": "collectibles/equip_icon_eye_blue.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 50, "effect": {"xp_bonus_percent": 6, "gold_bonus_percent": 6, "luck_gem_chance_percent": 6}, "effect_description": "+6% XP, Gold, Luck", "rarity": "epic"},
    ...
    {"id": "shield_blue", "name": "Blue Shield", "image": "collectibles/equip_icon_shield_blue.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 55, "effect": {"quest_reward_bonus_percent": 25}, "effect_description": "+25% daily quest rewards", "rarity": "epic"},
    ...
    {"id": "gemstone", "name": "Gemstone", "image": "collectibles/icon_gemstone.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 70, "effect": {"gold_bonus_percent": 12, "luck_gem_chance_percent": 8}, "effect_description": "+12% Gold, Luck 8%", "rarity": "epic"},
    ...
    {"id": "arrow_sharp", "name": "Falcon Bow", "image": "collectibles/icon_equip_arrow.png", "cost_gold": 520, "unlock_with_gems": True, "unlock_at_level": 72, "effect": {"quest_reward_bonus_percent": 15}, "effect_description": "+15% daily quest rewards", "rarity": "epic"},
    ...
    {"id": "tome_begin", "name": "Tome of Beginnings", "image": "collectibles/icon_book_0.png", "cost_gold": None, "unlock_with_gems": True, "unlock_at_level": 90, "effect": {"prestige_bonus_points": 1}, "effect_description": "+1 prestige point every time you prestige", "rarity": "legendary"},
    {"id": "candle_focus", "name": "Candle of Focus", "image": "collectibles/icon_candle.png", "cost_gold": 750, "unlock_with_gems": False, "unlock_at_level": 90, "effect": {"quest_reward_bonus_percent": 20}, "effect_description": "+20% daily quest rewards (gold-only)", "rarity": "legendary"},
    ...
    {"id": "lamp_enchanted", "name": "Enchanted Lamp", "image": "collectibles/icon_lamp.png", "cost_gold": 900, "unlock_with_gems": False, "unlock_at_level": 110, "effect": {"gold_bonus_percent": 10, "quest_reward_bonus_percent": 10}, "effect_description": "+10% Gold, +10% daily quest rewards (gold-only)", "rarity": "legendary"},
...
def quest_reward_bonus_percent(owned_ids: list[str]) -> float:
    """Total quest reward bonus (primarily gems) from owned collectibles."""
    return _sum_effect(owned_ids, "quest_reward_bonus_percent")
